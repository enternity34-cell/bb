...
const generateMessageID = () => 'SHIINA-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
 ...
 */
const fetchLatestWaWeb = async (options = {}) => {
...
exports.fetchLatestWaWeb = fetchLatestWaWeb;
/**
